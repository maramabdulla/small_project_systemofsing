...
.then(data =>{
    ...
    document.getElementById("tablesearch").innerHTML ='<br><input value="name_subject"><input value="name_teacher"><input value="number_set"><input value="time"><br><input value="'+ data.name_subject + '"> <input value="'+ data.name_teacher + '">  <input value="'+ data.number_set + '">  <input value="'+ data.time + '">';
